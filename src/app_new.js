...
let sliderTemplate = {
    ...
    template:`
        <div>
            ...
            <input type="range" class="form-range" v-model="radiusVal" @change="onChange" id="distance-slider" min="0.1" max="100" step="0.5"style="width:100%">
        </div>
    `
}
            ...
            <div class="leaflet-sidebar-content">
                ...
                <div class="leaflet-sidebar-pane" id="search-tab">
                    ...
                    <div>
                        ...
                        <slider @radiusVal="radiusVal"></slider>
